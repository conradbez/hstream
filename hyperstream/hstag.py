...
class HsDoc(Doc):
    ...
    def tag(self, tag_name, *args, **kwargs):
        return self.__class__.Tag(self, tag_name, _attributes(args, kwargs), path_to_app_db=kwargs.get('path_to_app_db', 'app_db'))
    ...
    class Tag(Doc.Tag):
        ...
        def __enter__(self):
            ...
            with shelve.open(str(self.path_to_app_db)) as app_db:
                ...
                components[f'{HS_HTML_CONSTANT}{len(components)}'] = f'<{self.doc.current_tag.name}>'
